...
//  Test
//
//  Created by wangwei on 2022/5/26.
//

#import "MMMiddleMan.h"
...
@interface MMMiddleMan () <NSStreamDelegate,NSURLSessionDelegate>
...
- (void)startLoading {
    ...
    request.URL = [NSURL URLWithString:[request.URL.absoluteString stringByReplacingOccurrencesOfString:@"qaapi.meeshow.com" withString:@"47.95.119.233"]];
    [request setValue:@"qaapi.meeshow.com" forHTTPHeaderField:@"host"];
    // 表示该请求已经被处理，防止无限循环
